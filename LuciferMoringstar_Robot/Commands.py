...
async def bot_info(bot, message):
    buttons = [
        [
            InlineKeyboardButton('🍿 ᴊᴏɪɴ ᴏᴜʀ ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ 🍿', url='https://t.me/MFCMCHANNEL'),
            InlineKeyboardButton('🍁 ʙᴏᴛ ɢʀᴏᴜᴘ 🍁', url='https://t.me/MOVIECRAZE11')
        ]
        ]
